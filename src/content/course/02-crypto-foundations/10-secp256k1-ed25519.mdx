...
<BlockchainCurveUsage client:visible />
...
TON выбрал Ed25519 (а не secp256k1, как Bitcoin/Ethereum) -- отчасти из-за скорости подписи, отчасти из-за детерминированности. Сравнение архитектурных последствий этого выбора есть в курсе по TON.

<CrossCourseRef
  courseId="ton-blockchain"
  lessonSlug="01-ton-architecture/06-ton-vs-ethereum"
  label="TON vs Ethereum: ключевые различия"
  preview="TON Ed25519 vs Ethereum secp256k1, актор-модель vs синхронные вызовы, шардирование L1 vs rollups L2"
/>

...
<KnowledgeCheck
  question="При каком значении Health Factor позиция становится доступной для ликвидации?"
  answer="При HF < 1.0. Формула: HF = (Collateral_USD * Liquidation_Threshold) / Debt_USD. Когда HF падает ниже 1, взвешенный залог больше не покрывает долг, и любой адрес может стать ликвидатором."
/>
...
<LiquidationStepThroughDiagram client:visible />
...
<LiquidatorProfitDiagram client:visible />
...
<KnowledgeCheck
  question="Почему каскадные ликвидации усиливают обвал цены актива?"
  answer="Ликвидации продают залог на рынке -> давление на цену -> цена падает -> ещё больше позиций получают HF < 1 -> новые ликвидации -> ещё больше продаж. Цепная реакция может привести к обвалу цены на 30-50% за часы."
/>
...
<LiquidationCascadeDiagram client:visible />

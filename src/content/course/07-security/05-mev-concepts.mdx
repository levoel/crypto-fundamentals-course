...
<KnowledgeCheck
  question="Опишите роли 5 участников MEV supply chain."
  answer="1) Users -- отправляют транзакции. 2) Searchers -- мониторят mempool, находят MEV-возможности, создают bundles. 3) Builders -- собирают оптимальные блоки из bundles. 4) Relays -- передают блоки через commit-reveal. 5) Validators (Proposers) -- подписывают блок с наивысшей bid."
/>
...
<MEVTypesTableDiagram client:visible />
...
<KnowledgeCheck
  question="Почему PBS (Proposer-Builder Separation) снижает централизацию валидаторов?"
  answer="До PBS майнеры сами собирали блоки и извлекали MEV -- преимущество для крупных игроков. PBS разделяет: builders конкурируют за оптимальный блок, validators просто выбирают блок с наивысшей ставкой. Даже home staker получает MEV-доход через MEV-Boost."
/>

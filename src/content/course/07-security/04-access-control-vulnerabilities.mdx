...
import { AccessControlComparisonDiagram, RoleHierarchyDiagram, RBACHierarchyDiagram } from '../../../components/diagrams/module6/AccessControlDiagrams';
...
<RBACHierarchyDiagram client:visible />

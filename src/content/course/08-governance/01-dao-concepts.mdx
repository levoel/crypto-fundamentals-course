...
<KnowledgeCheck
  question="Какие три ключевые характеристики определяют DAO и чем DAO отличается от традиционной организации?"
  answer="DAO -- Decentralized (нет единого центра принятия решений), Autonomous (исполнение решений автоматическое через смарт-контракт), Organization (координация людей). В отличие от традиционной организации, нет CEO и совета директоров -- правила это код, решения принимаются голосованием token holders."
/>
...
<KnowledgeCheck
  question="Почему хак The DAO (2016) привел к хардфорку Ethereum и какой урок из этого извлечен?"
  answer="The DAO потеряла $60M из $150M через reentrancy-уязвимость. Сообщество раскололось: ETH откатил транзакцию (приоритет -- защита пользователей), ETC сохранил принцип 'код -- закон'. Урок: governance code IS the protocol -- уязвимость в governance контракте катастрофична. Это привело к созданию аудированной библиотеки OpenZeppelin Governor."
/>

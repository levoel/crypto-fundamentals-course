...
<IndexingSpeedDiagram client:visible />
...
<KnowledgeCheck
  question="Каковы три ключевых различия между Subsquid, The Graph и SubQuery?"
  answer="Язык: Subsquid и SubQuery -- TypeScript, The Graph -- AssemblyScript. Скорость: Subsquid 1K-50K блоков/сек (batch), The Graph ~100 (sequential), SubQuery ~300. Децентрализация: The Graph -- зрелая сеть (GRT, 500+ indexers), SubQuery и Subsquid -- растущие сети."
/>

## Когда какой инструмент?

<DecisionTreeDiagram client:visible />
...
<KnowledgeCheck
  question="Когда выбрать Subsquid, а когда The Graph для вашего проекта?"
  answer="Subsquid: максимальная скорость индексации, аналитика больших объёмов, TypeScript удобство. The Graph: зрелая децентрализованная инфраструктура (500+ indexers, GRT стимулирование), censorship resistance, крупные DeFi протоколы."
/>

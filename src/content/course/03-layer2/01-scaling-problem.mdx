...
Bitcoin, Ethereum L1: Decentralization + Security
Solana, BSC:          Security + Scalability
Traditional DB:       Scalability + Decentralization (centralized)
```
...
L1 (Ethereum)
    ...
    └──► Rollup Contract
        ...
        Sequencer
         ...
         ┌────┴────┐
         │         │
    Execute txs   Batch txs
         │         │
         └────┬────┘
              │
              ▼
    Post batch + proof/data to L1
```
